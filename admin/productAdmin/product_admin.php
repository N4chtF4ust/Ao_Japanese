...
<div class="page_title">
        ...
        <div class='table_wrapper'  >
            ...
            for ($i=1; $i <=10 ; $i++) { 
                ...
                echo "<table border='0' class='choice_content' id='table_wrapper$i'>";
...
function table(){
  ...
  xhr.onload = function () {
    document.getElementById(`table_wrapper${i}`).innerHTML = this.responseText;
  };
  xhr.open("POST", `table${i}.php`, true);
  xhr.send();
}
